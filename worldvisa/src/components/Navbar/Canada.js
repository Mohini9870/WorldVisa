        ...
        <div>
          ...
          <div className="main">
            ...
            <p className="para">
              ...
              world. this page provides an overview of over 100 immigration
              routes for skilled workers, businesspeople, and families, and
              families. o you wosh to move to Canada?then you've arrivied to the
              right place. CanadaVisa can help you determine how to make your
              Canada dream a reality. thhere are sevrel reasons why people opt
              to immigrateto Canada. Wheter it's to seek a high-quality
              education, to feel secure with free universal healthcare, or to
              enjoy Canada's high Standard of living, Canadaa has it all.
            </p>
          </div>
          <div>
          ...
          <Row className="mb-3">
            ...
            <Col>
              {showResults && (
                <Card
                  className="card shadow p-1 mb-5 bg-white rounded"
                  style={{ width: "22rem", marginRight: "175px" }}
                >
                  <Card.Body>
                    <img
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "#C5C5C5" }} className="ms-5">
                  Carring nearly 100+ year of combined experise in the
                  immigration industry, our team of professional migration
                  lawyers and solicitors is here to guide you step of the
                </p>
              </div>
              <div>
                <h5
